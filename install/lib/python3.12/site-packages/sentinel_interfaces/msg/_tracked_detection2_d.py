...
class Metaclass_TrackedDetection2D(type):
    """Metaclass of message 'TrackedDetection2D'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__tracked_detection2_d
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__tracked_detection2_d
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__tracked_detection2_d
            cls._TYPE_SUPPORT = module.type_support_msg__msg__tracked_detection2_d
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__tracked_detection2_d
...
class TrackedDetection2D(metaclass=Metaclass_TrackedDetection2D):
    """Message class 'TrackedDetection2D'."""
