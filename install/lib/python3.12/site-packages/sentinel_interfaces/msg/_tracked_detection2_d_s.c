...
bool sentinel_interfaces__msg__tracked_detection2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sentinel_interfaces.msg._tracked_detection2_d.TrackedDetection2D", full_classname_dest, 64) == 0);
  }
  sentinel_interfaces__msg__TrackedDetection2D * ros_message = _ros_message;
  {  // track_id
...
{
  /* NOTE(esteve): Call constructor of TrackedDetection2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sentinel_interfaces.msg._tracked_detection2_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrackedDetection2D");
