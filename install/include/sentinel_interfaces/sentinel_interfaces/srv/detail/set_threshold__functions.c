...
sentinel_interfaces__srv__SetThreshold_Request__create(void)
{
  ...
  sentinel_interfaces__srv__SetThreshold_Request * msg = (sentinel_interfaces__srv__SetThreshold_Request *)allocator.allocate(sizeof(sentinel_interfaces__srv__SetThreshold_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sentinel_interfaces__srv__SetThreshold_Request));
  bool success = sentinel_interfaces__srv__SetThreshold_Request__init(msg);
  if (!success) {
...
sentinel_interfaces__srv__SetThreshold_Request__destroy(sentinel_interfaces__srv__SetThreshold_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    sentinel_interfaces__srv__SetThreshold_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
sentinel_interfaces__srv__SetThreshold_Request__Sequence__init(sentinel_interfaces__srv__SetThreshold_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sentinel_interfaces__srv__SetThreshold_Request * data = NULL;

  if (size) {
    data = (sentinel_interfaces__srv__SetThreshold_Request *)allocator.zero_allocate(size, sizeof(sentinel_interfaces__srv__SetThreshold_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sentinel_interfaces__srv__SetThreshold_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sentinel_interfaces__srv__SetThreshold_Request__fini(&data[i - 1]);
      }
...
sentinel_interfaces__srv__SetThreshold_Request__Sequence__fini(sentinel_interfaces__srv__SetThreshold_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sentinel_interfaces__srv__SetThreshold_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sentinel_interfaces__srv__SetThreshold_Request__Sequence * array = (sentinel_interfaces__srv__SetThreshold_Request__Sequence *)allocator.allocate(sizeof(sentinel_interfaces__srv__SetThreshold_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sentinel_interfaces__srv__SetThreshold_Request__Sequence__init(array, size);
  if (!success) {
...
sentinel_interfaces__srv__SetThreshold_Request__Sequence__destroy(sentinel_interfaces__srv__SetThreshold_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sentinel_interfaces__srv__SetThreshold_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sentinel_interfaces__srv__SetThreshold_Request__Sequence__are_equal(const sentinel_interfaces__srv__SetThreshold_Request__Sequence * lhs, const sentinel_interfaces__srv__SetThreshold_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sentinel_interfaces__srv__SetThreshold_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sentinel_interfaces__srv__SetThreshold_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sentinel_interfaces__srv__SetThreshold_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sentinel_interfaces__srv__SetThreshold_Request * data =
      (sentinel_interfaces__srv__SetThreshold_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sentinel_interfaces__srv__SetThreshold_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sentinel_interfaces__srv__SetThreshold_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sentinel_interfaces__srv__SetThreshold_Request__copy(
...
sentinel_interfaces__srv__SetThreshold_Response__init(sentinel_interfaces__srv__SetThreshold_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    sentinel_interfaces__srv__SetThreshold_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sentinel_interfaces__srv__SetThreshold_Response * msg = (sentinel_interfaces__srv__SetThreshold_Response *)allocator.allocate(sizeof(sentinel_interfaces__srv__SetThreshold_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sentinel_interfaces__srv__SetThreshold_Response));
  bool success = sentinel_interfaces__srv__SetThreshold_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
sentinel_interfaces__srv__SetThreshold_Response__Sequence__init(sentinel_interfaces__srv__SetThreshold_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sentinel_interfaces__srv__SetThreshold_Response * data = NULL;

  if (size) {
    data = (sentinel_interfaces__srv__SetThreshold_Response *)allocator.zero_allocate(size, sizeof(sentinel_interfaces__srv__SetThreshold_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sentinel_interfaces__srv__SetThreshold_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        sentinel_interfaces__srv__SetThreshold_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
sentinel_interfaces__srv__SetThreshold_Response__Sequence__fini(sentinel_interfaces__srv__SetThreshold_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      sentinel_interfaces__srv__SetThreshold_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sentinel_interfaces__srv__SetThreshold_Response__Sequence * array = (sentinel_interfaces__srv__SetThreshold_Response__Sequence *)allocator.allocate(sizeof(sentinel_interfaces__srv__SetThreshold_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sentinel_interfaces__srv__SetThreshold_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
sentinel_interfaces__srv__SetThreshold_Response__Sequence__destroy(sentinel_interfaces__srv__SetThreshold_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sentinel_interfaces__srv__SetThreshold_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sentinel_interfaces__srv__SetThreshold_Response__Sequence__are_equal(const sentinel_interfaces__srv__SetThreshold_Response__Sequence * lhs, const sentinel_interfaces__srv__SetThreshold_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sentinel_interfaces__srv__SetThreshold_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sentinel_interfaces__srv__SetThreshold_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sentinel_interfaces__srv__SetThreshold_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sentinel_interfaces__srv__SetThreshold_Response * data =
      (sentinel_interfaces__srv__SetThreshold_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sentinel_interfaces__srv__SetThreshold_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sentinel_interfaces__srv__SetThreshold_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!sentinel_interfaces__srv__SetThreshold_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
sentinel_interfaces__srv__SetThreshold_Event__init(sentinel_interfaces__srv__SetThreshold_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    sentinel_interfaces__srv__SetThreshold_Event__fini(msg);
    return false;
  }
  // request
  if (!sentinel_interfaces__srv__SetThreshold_Request__Sequence__init(&msg->request, 0)) {
    sentinel_interfaces__srv__SetThreshold_Event__fini(msg);
    return false;
  }
  // response
  if (!sentinel_interfaces__srv__SetThreshold_Response__Sequence__init(&msg->response, 0)) {
    sentinel_interfaces__srv__SetThreshold_Event__fini(msg);
    return false;
  }
  return true;
...
sentinel_interfaces__srv__SetThreshold_Event__fini(sentinel_interfaces__srv__SetThreshold_Event * msg)
{
  ...
  // request
  sentinel_interfaces__srv__SetThreshold_Request__Sequence__fini(&msg->request);
  // response
  sentinel_interfaces__srv__SetThreshold_Response__Sequence__fini(&msg->response);
}
...
sentinel_interfaces__srv__SetThreshold_Event__are_equal(const sentinel_interfaces__srv__SetThreshold_Event * lhs, const sentinel_interfaces__srv__SetThreshold_Event * rhs)
{
  ...
  // request
  if (!sentinel_interfaces__srv__SetThreshold_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!sentinel_interfaces__srv__SetThreshold_Response__Sequence__are_equal(
  ...
  sentinel_interfaces__srv__SetThreshold_Event * output)
{
  ...
  // request
  if (!sentinel_interfaces__srv__SetThreshold_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!sentinel_interfaces__srv__SetThreshold_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sentinel_interfaces__srv__SetThreshold_Event * msg = (sentinel_interfaces__srv__SetThreshold_Event *)allocator.allocate(sizeof(sentinel_interfaces__srv__SetThreshold_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sentinel_interfaces__srv__SetThreshold_Event));
  bool success = sentinel_interfaces__srv__SetThreshold_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
sentinel_interfaces__srv__SetThreshold_Event__Sequence__init(sentinel_interfaces__srv__SetThreshold_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sentinel_interfaces__srv__SetThreshold_Event * data = NULL;

  if (size) {
    data = (sentinel_interfaces__srv__SetThreshold_Event *)allocator.zero_allocate(size, sizeof(sentinel_interfaces__srv__SetThreshold_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sentinel_interfaces__srv__SetThreshold_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        sentinel_interfaces__srv__SetThreshold_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
sentinel_interfaces__srv__SetThreshold_Event__Sequence__fini(sentinel_interfaces__srv__SetThreshold_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      sentinel_interfaces__srv__SetThreshold_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sentinel_interfaces__srv__SetThreshold_Event__Sequence * array = (sentinel_interfaces__srv__SetThreshold_Event__Sequence *)allocator.allocate(sizeof(sentinel_interfaces__srv__SetThreshold_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sentinel_interfaces__srv__SetThreshold_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
sentinel_interfaces__srv__SetThreshold_Event__Sequence__destroy(sentinel_interfaces__srv__SetThreshold_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sentinel_interfaces__srv__SetThreshold_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sentinel_interfaces__srv__SetThreshold_Event__Sequence__are_equal(const sentinel_interfaces__srv__SetThreshold_Event__Sequence * lhs, const sentinel_interfaces__srv__SetThreshold_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sentinel_interfaces__srv__SetThreshold_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sentinel_interfaces__srv__SetThreshold_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sentinel_interfaces__srv__SetThreshold_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sentinel_interfaces__srv__SetThreshold_Event * data =
      (sentinel_interfaces__srv__SetThreshold_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sentinel_interfaces__srv__SetThreshold_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sentinel_interfaces__srv__SetThreshold_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!sentinel_interfaces__srv__SetThreshold_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
