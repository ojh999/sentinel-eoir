...
#ifndef SENTINEL_INTERFACES__MSG__DETAIL__YOLO_STATUS__TYPE_SUPPORT_H_
#define SENTINEL_INTERFACES__MSG__DETAIL__YOLO_STATUS__TYPE_SUPPORT_H_
...
#endif  // SENTINEL_INTERFACES__MSG__DETAIL__YOLO_STATUS__TYPE_SUPPORT_H_
