...
{
  new (message_memory) sentinel_interfaces::msg::MotorAngle(_init);
}

void MotorAngle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sentinel_interfaces::msg::MotorAngle *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorAngle_message_member_array[2] = {
  {
    ...
    offsetof(sentinel_interfaces::msg::MotorAngle, pan),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sentinel_interfaces::msg::MotorAngle, tilt),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorAngle_message_members = {
  ...
  2,  // number of fields
  sizeof(sentinel_interfaces::msg::MotorAngle),
...
{
  return &::sentinel_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorAngle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sentinel_interfaces, msg, MotorAngle)() {
  return &::sentinel_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorAngle_message_type_support_handle;
}
