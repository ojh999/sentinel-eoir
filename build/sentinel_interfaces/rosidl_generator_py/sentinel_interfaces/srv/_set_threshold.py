...
class SetThreshold_Event(metaclass=Metaclass_SetThreshold_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<sentinel_interfaces/SetThreshold_Request, 1>',
        'response': 'sequence<sentinel_interfaces/SetThreshold_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['sentinel_interfaces', 'srv'], 'SetThreshold_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['sentinel_interfaces', 'srv'], 'SetThreshold_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from sentinel_interfaces.srv import SetThreshold_Request
    ...
    def response(self, value):
        if self._check_fields:
            from sentinel_interfaces.srv import SetThreshold_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SetThreshold(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from sentinel_interfaces.srv import _set_threshold
...
class SetThreshold(metaclass=Metaclass_SetThreshold):
    from sentinel_interfaces.srv._set_threshold import SetThreshold_Request as Request
    from sentinel_interfaces.srv._set_threshold import SetThreshold_Response as Response
    from sentinel_interfaces.srv._set_threshold import SetThreshold_Event as Event
