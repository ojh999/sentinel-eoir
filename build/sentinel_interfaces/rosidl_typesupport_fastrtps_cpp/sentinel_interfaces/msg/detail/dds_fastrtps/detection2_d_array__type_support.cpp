...
#include "sentinel_interfaces/msg/detail/detection2_d_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const sentinel_interfaces::msg::Detection2D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const sentinel_interfaces::msg::Detection2DArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sentinel_interfaces::msg::Detection2DArray & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sentinel_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection2D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = sentinel_interfaces::msg::Detection2DArray;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sentinel_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Detection2D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const sentinel_interfaces::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sentinel_interfaces::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  return &sentinel_interfaces::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sentinel_interfaces, msg, Detection2DArray)() {
  return &sentinel_interfaces::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
