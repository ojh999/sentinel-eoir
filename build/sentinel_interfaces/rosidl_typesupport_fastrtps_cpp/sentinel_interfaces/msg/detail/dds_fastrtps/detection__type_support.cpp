...
#include "sentinel_interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sentinel_interfaces::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sentinel_interfaces::msg::Detection & ros_message)
{
  // Member: cx
  cdr >> ros_message.cx;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentinel_interfaces::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sentinel_interfaces::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sentinel_interfaces::msg::Detection *>(
    untyped_ros_message);
...
{
  return &sentinel_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sentinel_interfaces, msg, Detection)() {
  return &sentinel_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
