...
#include "sentinel_interfaces/msg/detail/detection2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sentinel_interfaces::msg::Detection2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sentinel_interfaces::msg::Detection2D & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentinel_interfaces::msg::Detection2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sentinel_interfaces::msg::Detection2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sentinel_interfaces::msg::Detection2D *>(
    untyped_ros_message);
...
{
  return &sentinel_interfaces::msg::typesupport_fastrtps_cpp::_Detection2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sentinel_interfaces, msg, Detection2D)() {
  return &sentinel_interfaces::msg::typesupport_fastrtps_cpp::_Detection2D__handle;
}
