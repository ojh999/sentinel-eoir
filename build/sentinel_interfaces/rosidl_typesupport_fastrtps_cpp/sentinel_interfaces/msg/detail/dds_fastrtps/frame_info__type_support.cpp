...
#include "sentinel_interfaces/msg/detail/frame_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sentinel_interfaces::msg::FrameInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sentinel_interfaces::msg::FrameInfo & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentinel_interfaces::msg::FrameInfo;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sentinel_interfaces
max_serialized_size_key_FrameInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const sentinel_interfaces::msg::FrameInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sentinel_interfaces::msg::FrameInfo *>(
    untyped_ros_message);
...
{
  return &sentinel_interfaces::msg::typesupport_fastrtps_cpp::_FrameInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sentinel_interfaces, msg, FrameInfo)() {
  return &sentinel_interfaces::msg::typesupport_fastrtps_cpp::_FrameInfo__handle;
}
