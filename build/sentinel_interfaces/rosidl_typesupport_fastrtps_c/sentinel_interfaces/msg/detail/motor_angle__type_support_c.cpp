...
#include "sentinel_interfaces/msg/detail/motor_angle__rosidl_typesupport_fastrtps_c.h"
...
using _MotorAngle__ros_msg_type = sentinel_interfaces__msg__MotorAngle;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentinel_interfaces__msg__MotorAngle;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sentinel_interfaces__msg__MotorAngle * ros_message = static_cast<const sentinel_interfaces__msg__MotorAngle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sentinel_interfaces__msg__MotorAngle(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sentinel_interfaces__msg__MotorAngle * ros_message = static_cast<sentinel_interfaces__msg__MotorAngle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sentinel_interfaces__msg__MotorAngle(cdr, ros_message);
}

static uint32_t _MotorAngle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sentinel_interfaces__msg__MotorAngle(
...
static size_t _MotorAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sentinel_interfaces__msg__MotorAngle(
