...
#include "sentinel_interfaces/msg/detail/tracked_detection2_d__rosidl_typesupport_fastrtps_c.h"
...
using _TrackedDetection2D__ros_msg_type = sentinel_interfaces__msg__TrackedDetection2D;
...
{
  const _TrackedDetection2D__ros_msg_type * ros_message = static_cast<const _TrackedDetection2D__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentinel_interfaces__msg__TrackedDetection2D;
    is_plain =
      (
...
static bool _TrackedDetection2D__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sentinel_interfaces__msg__TrackedDetection2D * ros_message = static_cast<const sentinel_interfaces__msg__TrackedDetection2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sentinel_interfaces__msg__TrackedDetection2D(ros_message, cdr);
}

static bool _TrackedDetection2D__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  sentinel_interfaces__msg__TrackedDetection2D * ros_message = static_cast<sentinel_interfaces__msg__TrackedDetection2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sentinel_interfaces__msg__TrackedDetection2D(cdr, ros_message);
}

static uint32_t _TrackedDetection2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sentinel_interfaces__msg__TrackedDetection2D(
      untyped_ros_message, 0));
}

static size_t _TrackedDetection2D__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_sentinel_interfaces__msg__TrackedDetection2D(
...
static message_type_support_callbacks_t __callbacks_TrackedDetection2D = {
  "sentinel_interfaces::msg",
  "TrackedDetection2D",
  _TrackedDetection2D__cdr_serialize,
  _TrackedDetection2D__cdr_deserialize,
  _TrackedDetection2D__get_serialized_size,
  _TrackedDetection2D__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _TrackedDetection2D__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackedDetection2D,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sentinel_interfaces, msg, TrackedDetection2D)() {
  return &_TrackedDetection2D__type_support;
}
